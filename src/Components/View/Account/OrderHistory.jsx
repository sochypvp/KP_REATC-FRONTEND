  ...
  return (
    <article>
      <div className="flex items-center justify-between pb-10 pr-4">
        <p className="text-black uppercase font-extrabold text-lg max-md:text-base pb-5">Order History</p>
        <p className="text-black font-normal text-sm">XX items</p>
      </div>
      <div className="flex flex-wrap justify-items-start">
        {currentItems.map((favData) => {
          var shortName = "";
      ...
      <ul className="flex justify-center mt-4">
        ...
        <li
          className={`cursor-pointer mx-1 px-3 py-1 rounded-full ${
            currentPage === Math.ceil(KK[0].data.length / itemsPerPage)
              ? "bg-gray-100"
              : "bg-gray-200"
          }`}
          onClick={nextPage}
